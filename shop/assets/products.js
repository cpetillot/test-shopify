...
theme.Product = (function () {
  ...
  function Product(container) {
    ...
    $("body").on("click", selectors.addToCart, function () {
      // console.log("T4 - Add to cart");
      var originalAddToCartParent = $(this).parent("form");
      var originalAddToCartId = originalAddToCartParent
        .find(selectors.originalSelectorId)
        .val();
      //console.log('add to cart', $(selectors.originalSelectorId).val());
      CartJS.addItem(
        originalAddToCartId,
        1,
        {},
